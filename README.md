...
* May 27, 2022:  We continue our quest of advancing the state-of-the-art on online policies for the DVRPSR.  Another expert on dynamic VRPs has joined our team, and we took up the challenge of improving even more the runtimes of the potential-based policy (PbP), while keeping the same performance that distinguishes PbP from general-purpose ADP methods.  More news on that to follow (hopefully) soon!
