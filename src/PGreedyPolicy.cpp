...
vector<Decision> PGreedyPolicy::decisions(const State& s) const {
...
vector<tuple<Decision, double>> PGreedyPolicy::decisionsPotentials(
        const State& s) const {
...
std::string PGreedyPolicy::texString() const {
